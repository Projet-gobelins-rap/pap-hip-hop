...
export enum GLTF_ASSET {
  ...
  HEAD_NEPAL = 'HEAD_NEPAL',
  HEAD_FUTURA = 'HEAD_FUTURA',
  NPC_DAN_HEAD = 'NPC_DAN_HEAD',
  PLAYER_TICARET_HEAD = 'PLAYER_TICARET_HEAD',
  FRANCOIS_HEAD = 'FRANCOIS_HEAD', 
  TREE = 'TREE',
  BITE = 'BITE',
...
export enum TEXTURE_ASSET {
  ...
  NPC_FRANCOIS_ARMS_TEXTURE = 'NPC_FRANCOIS_ARMS_TEXTURE',
  ...
  FUTURA_PANT_TEXTURE = 'FUTURA_PANT_TEXTURE',
  ...
  SLOT_BUILDING_TYPE_1_FUTURA = 'SLOT_BUILDING_TYPE_1_FUTURA',
